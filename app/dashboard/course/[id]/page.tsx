    ...
    <div className="flex h-screen bg-[#080808] text-white overflow-hidden">
              ...
              <div key={mod.id}>
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p className={`text-xs font-bold truncate ${modDone ? "text-white/50" : "text-white/80"}`}>{mod.title}</p>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          {/* ── OVERVIEW ── */}
          {!lesson && (
            <div className="w-full px-6 py-10 space-y-10 max-w-6xl mx-auto">
              ...
              <div className="flex flex-col gap-4">
                ...
                <h1 className="text-4xl font-black leading-tight">Vekto Masterclass</h1>
          ...
          {lesson && (
            <>
              ...
              {/* Below video */}
              <div className="w-full px-6 py-8 space-y-8 max-w-6xl mx-auto">
