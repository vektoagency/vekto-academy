  ...
  const steps = [
    {
      ...
      unlocks: [
        { icon: "▸", text: "Midjourney, Runway, Sora, Kling · основен toolkit" },
        { icon: "▸", text: "Първи завършен AI клип от 15-30 секунди" },
        { icon: "▸", text: "Монтаж в CapCut/Premiere · cuts, темпо, sound" },
      ],
      pay: "Без приход",
      payNote: "Фокус · технически умения и темпо",
    },
    {
      month: "Месец 2",
      label: "Арена",
      ...
      unlocks: [
        { icon: "★", text: "Предаваш 4+ проекта под реален deadline" },
        { icon: "★", text: "Писмен фийдбек от ментор на всеки проект" },
        { icon: "★", text: "Първи реални награди от Арена (€30-100 на задача)" },
      ],
      pay: "€200 – €1000/мес",
    ...
    },
    {
      ...
      unlocks: [
        { icon: "●", text: "Showreel от 60-90 секунди с най-силните ти работи" },
        { icon: "●", text: "Готови шаблони за cold outreach към марки" },
        { icon: "●", text: "Първи преговори с клиент · цена, срок, договор" },
      ],
      pay: "€200 – €1000/мес",
      ...
      <div className="max-w-5xl mx-auto relative z-10">
        ...
        <div className="mt-10 flex flex-col sm:flex-row items-stretch sm:items-center justify-center gap-4">
          ...
          <p className="text-white/40 text-xs sm:text-sm text-center sm:text-left max-w-sm">
            Учим те да стоиш на крака сам. Ако се докажеш — ние сме една от отворените врати.
          </p>
        </div>
      </div>
    </section>
            ...
            <div className="p-5 sm:p-8">
              ...
              <ol className="space-y-3 sm:space-y-4 mb-6">
                {[
                  ...
                  { n: "04", t: "Плащане в края на месеца", s: "Vekto превежда наградите на IBAN — без посредници." },
                ].map((step) => (
...
const faq = [
  ...
  },
  {
    ...
    a: "Да. Задачите са реални от клиенти на агенцията — не симулация. В края на всеки месец Vekto разпределя пула и всеки победител получава парите си директно на IBAN.",
  },
  {
  ...
  },
  {
    ...
    a: "Няма минимум. Колкото повече отделяш, толкова по-добри резултати ще имаш в Арена и по-голям шанс за дългосрочни Vekto задачи.",
  },
  {
