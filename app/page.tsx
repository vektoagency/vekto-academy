  ...
  const steps = [
    {
      ...
      unlocks: [
        { icon: "▸", text: "Овладяваш AI инструментите · от идея до финален кадър" },
        { icon: "▸", text: "Сглобяваш видеа, които държат внимание от начало до край" },
        { icon: "▸", text: "Развиваш визуалния си вкус и око за детайл" },
      ],
      pay: "Без приход",
    ...
    },
    {
      ...
      unlocks: [
        { icon: "★", text: "Работиш под реален срок без компромис с качеството" },
    ...
    },
    {
      ...
      unlocks: [
        { icon: "●", text: "Превръщаш работите си в убедителна ролка" },
        { icon: "●", text: "Презентираш и договаряш като професионалист" },
        { icon: "●", text: "Изграждаш собствен поток от клиенти" },
      ],
      pay: "€200–1000/мес",
