  ...
  const steps = [
    {
      month: "Месец 1",
      label: "Основи",
      title: "Овладяваш AI инструментите и production workflow-а.",
      unlocks: [
        { icon: "▸", text: "AI prompting · от идея до готов shot" },
        { icon: "▸", text: "Монтаж темп · бързо и чисто" },
        { icon: "▸", text: "Изграждаш първи рефлекс за визия" },
      ],
      pay: "Без приход",
      payNote: "Фокус · технически скилове и темпо",
    },
    {
      month: "Месец 2",
      label: "Арена",
      title: "Работиш под deadline. Изграждаш production темпо.",
      unlocks: [
        { icon: "★", text: "Consistency под pressure" },
        { icon: "★", text: "Peer review · виждаш силните си страни" },
        { icon: "★", text: "Натрупваш завършени проекти" },
      ],
      pay: "€0 – €500/мес",
      payNote: "Зависи от brief-овете които печелиш",
    },
    {
      month: "Месец 3",
      label: "Портфолио",
      title: "Превръщаш работата си в reel за клиенти.",
      unlocks: [
        { icon: "●", text: "Pitching · как се продава твоя подход" },
        { icon: "●", text: "Личен бранд · ставаш видим навън" },
        { icon: "●", text: "Шанс за shortlist + freelance brief-ове" },
      ],
      pay: "€500+/мес потенциал",
      payNote: "Портфолиото отваря врати — навън или с Vekto",
      highlight: true,
    },
  ];
