  ...
  const steps = [
    {
      ...
      unlocks: [
        ...
        { icon: "▸", text: "Монтажно темпо · бързо и чисто" },
        { icon: "▸", text: "Изграждаш първи рефлекс за визия" },
      ],
      pay: "Без приход",
    ...
    },
    {
      ...
      unlocks: [
        ...
        { icon: "★", text: "Ревю от колеги · виждаш силните си страни" },
        { icon: "★", text: "Натрупваш завършени проекти" },
      ],
      pay: "€0 – €500/мес",
    ...
    },
    {
      ...
      unlocks: [
        ...
        { icon: "●", text: "Преговори · договаряш цена и срок с клиент" },
        { icon: "●", text: "Намираш собствени клиенти — не само през нас" },
      ],
      pay: "€500+/мес потенциал",
...
const faq = [
  ...
  },
  {
    ...
    a: "Няма минимум. Колкото повече отделяш, толкова по-добри резултати ще имаш в Арена и по-голям шанс за дългосрочни Vekto задачи. Успяващите членове влагат 5-10 часа седмично.",
  },
  {
